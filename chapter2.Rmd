...
Based on the information we learned from the correlations, it seems "Attitude" will probably be the strongest predictor for "Points". We will also test whether adding the learning variables to the model will improve the model fit and if participant gender has any effect in this contex. "Age" variable is dropped at this point, since the earlier inspections revealed problems with the distribution, outliers, and low correlation with the response variable.
\   
\  
